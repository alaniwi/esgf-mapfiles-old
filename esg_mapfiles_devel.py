...
def _get_args():
    ...
    #return parser.parse_args(['/prodigfs/esg/CMIP5/process/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20120430/', '-p', 'cmip5', '-v'])
    #return parser.parse_args(['/prodigfs/esg/CMIP5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/', '-p', 'cmip5', '-d', '-v'])
    #return parser.parse_args(['/ccc/work/cont003/cordex/cordex/output/EUR-11/IPSL-INERIS/IPSL-IPSL-CM5A-MR/historical/r1i1p1/IPSL-INERIS-WRF331F/v1/mon/tas/v20140301/', '-p', 'cordex', '-d', '-v'])
